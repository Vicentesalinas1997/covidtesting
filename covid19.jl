...
function person_p(t,t_inf,t_sin,t_rec,p_sinto,asin,scalar_asint)
	...
	if asin==0
		...
		y_vec = [ 0, 0.63, 0.8, 0.79, 0.64, 0.43, 0.19, 0.08, 0.00,0.00]* (p_sinto/0.8)*scalar_asint
	end
...
function simulation(N,Group,T,Tra,MRELR, f,G,peak,t_peak,p_int,p_ext,γ,p_false_positive,R,Politica,tpool,random,quienes,cuarentena,z,dias_atras,scalar_asint,test_sym,distribuir)
...
#Se calcula un promedio de las simulaciones
	...
	mNTest2=mNTest2/R
	VInf=VInf/R
MFocos=zeros(Repeticiones,10)
for i in 1:10
MFocos[:,i]=Infect.>=ones(R)*0.1*i*N
end
Focos=sum(MFocos,dims=1)/R
    return mQua,mQua2,mInf,mInf2,mInf3, mNFpositive,  mNTest,mNTest2, mSy, maxInf, maxQua, maxSy, Infect, VInf,Focos
end
################################################################################################################################################
...
t_peak=ones(N)*12                 #Tiempo peak de contagio
...
v=vecgroup(Group)
MRELR=zeros(N,N,T,Repeticiones)
for repet in 1:Repeticiones
MRELR[:,:,:,repet]=interaciones(Group,Mrel,T,v)
end
global MRELR

	global ff, base_mQua,base_mQua2, base_mInf,base_mInf2,base_mInf3, base_mNFp, base_T, base_T2,base_mSy,base_maxInf,base_maxQua, base_maxSy, base_Infect, base_VInf, base_Focos
base_mQua,base_mQua2, base_mInf,base_mInf2,base_mInf3, base_mNFp, base_T, base_T2,base_mSy,base_maxInf,base_maxQua, base_maxSy, base_Infect, base_VInf,base_Focos= simulation(N,Group,T,Horario,MRELR, Diastest,Testgrupo,peak,t_peak,p_int,p_ext,Porasint,Probfp,Repeticiones,Politica,tpool,test,quienes,Cuaren,Diascuarentena,Diasatras,scalar_asint,TestSyn,distribuir)
end
if ff==2
	...
	global ideal_mQua,ideal_mQua2, ideal_mInf,ideal_mInf2,ideal_mInf3, ideal_mNFp, ideal_T,ideal_T2, ideal_mSy,ideal_maxInf,ideal_maxQua, ideal_maxSy, ideal_Infect, ideal_VInf, ideal_Focos
ideal_mQua,ideal_mQua2, ideal_mInf,ideal_mInf2,ideal_mInf3, ideal_mNFp, ideal_T,ideal_T2, ideal_mSy,ideal_maxInf,ideal_maxQua, ideal_maxSy, ideal_Infect, ideal_VInf,ideal_Focos= simulation(N,Group,T,Horario,MRELR, Diastest2,Testgrupo2,peak,t_peak,p_int,p_ext,Porasint,Probfp,Repeticiones,Politica2,tpool2,test2,quienes2,Cuaren2,Diascuarentena2,Diasatras2,scalar_asint,TestSyn2,distribuir2)
end
if ff==3
	...
	global f1_mQua,f1_mQua2, f1_mInf,f1_mInf2,f1_mInf3, f1_mNFp, f1_T, f1_T2, f1_mSy,f1_maxInf,f1_maxQua, f1_maxSy,f1_Infect, f1_VInf, f1_Focos
f1_mQua,f1_mQua2, f1_mInf,f1_mInf2,f1_mInf3, f1_mNFp, f1_T, f1_T2, f1_mSy,f1_maxInf,f1_maxQua, f1_maxSy,f1_Infect, f1_VInf,f1_Focos = simulation(N,Group,T,Horario,MRELR, Diastest3,Testgrupo3,peak,t_peak,p_int,p_ext,Porasint,Probfp,Repeticiones,Politica3,tpool3,test3,quienes3,Cuaren3,Diascuarentena3,Diasatras3,scalar_asint,TestSyn3,distribuir3)
end
if ff==4
	...
	global fr_mQua,fr_mQua2, fr_mInf,fr_mInf2,fr_mInf3, fr_mNFp, fr_T, fr_T2,fr_mSy,fr_maxInf,fr_maxQua, fr_maxSy, fr_Infect, fr_VInf, fr_Focos
fr_mQua,fr_mQua2, fr_mInf,fr_mInf2,fr_mInf3, fr_mNFp, fr_T, fr_T2,fr_mSy,fr_maxInf,fr_maxQua, fr_maxSy, fr_Infect, fr_VInf, fr_Focos = simulation(N,Group,T,Horario,MRELR, Diastest4,Testgrupo4,peak,t_peak,p_int,p_ext,Porasint,Probfp,Repeticiones,Politica4,tpool4,test4,quienes4,Cuaren4,Diascuarentena4,Diasatras4,scalar_asint,TestSyn4,distribuir4)
end
ff+=1
end
###############################################################################
...
\hline
\textbf{Política}&\textbf{ 10\% }&\textbf{ 20\% }&\textbf{ 30\% }&\textbf{ 40\% }&\textbf{ 50\% }&\textbf{ 60\% }&\textbf{ 70\% }&\textbf{ 80\% }&\textbf{ 90\% }&\textbf{ 100\% }\\ \hline
{{#:A}} \textbf{ {{Politica}} } {{#Focos}} & {{.}} {{/Focos}}\\  {{/:A}}\hline
\end{tabular}
\caption{Tabla con las \textit{probabilidades de focos} por política. }
\label{tab:TablaFocos}
\end{table}
