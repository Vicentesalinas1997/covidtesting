...
global N,Group,T,Horario,Mrel, Diastest,Testgrupo,p_int,p_ext,Porasint,Probfp,Repeticiones,Politica,tpool,test,quienes,Cuaren,Diascuarentena,Diasatras,TestSyn,distribuir,graficogrupo,nombregrafico,nombregrafico15,t_peak,scalar_asint,peak,NombreGrupo,NombreHorario, NameP, infopar,Pasint
...
Repeticiones=rr*procesadores
global MRELR

	global ff, base_mQua,base_mQua2, base_mInf,base_mInf2,base_mInf3, base_mNFp, base_T, base_T2,base_mSy, base_VInf
base_mQua,base_mQua2, base_mInf,base_mInf2,base_mInf3, base_mNFp, base_T, base_T2,base_mSy, base_VInf= simulation(N,Group,T,Horario,MRELR, Diastest,Testgrupo,peak,t_peak,p_int,p_ext,Porasint,Probfp,Repeticiones,Politica,tpool,test,quienes,Cuaren,Diascuarentena,Diasatras,scalar_asint,TestSyn,distribuir,vg)
#        [base_mQua,base_mQua2, base_mInf,base_mInf2,base_mInf3, base_mNFp, base_T, base_T2,base_mSy, base_VInf]=[base_mQua,base_mQua2, base_mInf,base_mInf2,base_mInf3, base_mNFp, base_T, base_T2,base_mSy, base_VInf]/Repeticiones
        base_mQua=base_mQua/Repeticiones
        base_mQua2=base_mQua2/Repeticiones
        base_mInf=base_mInf/Repeticiones
        base_mInf2=base_mInf2/Repeticiones
        base_mInf3=base_mInf3/Repeticiones
        base_mNFp=base_mNFp/Repeticiones
        base_T=base_T/Repeticiones
        base_T2=base_T2/Repeticiones
        base_mSy=base_mSy/Repeticiones
        base_VInf=base_VInf/Repeticiones
end
if ff==2
...
ideal_mQua,ideal_mQua2, ideal_mInf,ideal_mInf2,ideal_mInf3, ideal_mNFp, ideal_T,ideal_T2, ideal_mSy, ideal_VInf= simulation(N,Group,T,Horario,MRELR, Diastest2,Testgrupo2,peak,t_peak,p_int,p_ext,Porasint,Probfp,Repeticiones,Politica2,tpool2,test2,quienes2,Cuaren2,Diascuarentena2,Diasatras2,scalar_asint,TestSyn2,distribuir2,vg)
        ideal_mQua=ideal_mQua/Repeticiones
        ideal_mQua2=ideal_mQua2/Repeticiones
        ideal_mInf=ideal_mInf/Repeticiones
        ideal_mInf2=ideal_mInf2/Repeticiones
        ideal_mInf3=ideal_mInf3/Repeticiones
        ideal_mNFp=ideal_mNFp/Repeticiones
        ideal_T=ideal_T/Repeticiones
        ideal_T2=ideal_T2/Repeticiones
        ideal_mSy=ideal_mSy/Repeticiones
        ideal_VInf=ideal_VInf/Repeticiones

#        [ideal_mQua,ideal_mQua2, ideal_mInf,ideal_mInf2,ideal_mInf3, ideal_mNFp, ideal_T, ideal_T2,ideal_mSy, ideal_VInf]=[ideal_mQua,ideal_mQua2, ideal_mInf,ideal_mInf2,ideal_mInf3, ideal_mNFp, ideal_T, ideal_T2,ideal_mSy, ideal_VInf]/Repeticiones
end
if ff==3
...
f1_mQua,f1_mQua2, f1_mInf,f1_mInf2,f1_mInf3, f1_mNFp, f1_T, f1_T2, f1_mSy,f1_VInf= simulation(N,Group,T,Horario,MRELR, Diastest3,Testgrupo3,peak,t_peak,p_int,p_ext,Porasint,Probfp,Repeticiones,Politica3,tpool3,test3,quienes3,Cuaren3,Diascuarentena3,Diasatras3,scalar_asint,TestSyn3,distribuir3,vg)

        f1_mQua=f1_mQua/Repeticiones
        f1_mQua2=f1_mQua2/Repeticiones
        f1_mInf=f1_mInf/Repeticiones
        f1_mInf2=f1_mInf2/Repeticiones
        f1_mInf3=f1_mInf3/Repeticiones
        f1_mNFp=f1_mNFp/Repeticiones
        f1_T=f1_T/Repeticiones
        f1_T2=f1_T2/Repeticiones
        f1_mSy=f1_mSy/Repeticiones
        f1_VInf=f1_VInf/Repeticiones

#        [f1_mQua,f1_mQua2, f1_mInf,f1_mInf2,f1_mInf3, f1_mNFp, f1_T, f1_T2,f1_mSy, f1_VInf]=[f1_mQua,f1_mQua2, f1_mInf,f1_mInf2,f1_mInf3, f1_mNFp, f1_T, f1_T2,f1_mSy, f1_VInf]/Repeticiones
    end
if ff==4
...
fr_mQua,fr_mQua2, fr_mInf,fr_mInf2,fr_mInf3, fr_mNFp, fr_T, fr_T2,fr_mSy, fr_VInf = simulation(N,Group,T,Horario,MRELR, Diastest4,Testgrupo4,peak,t_peak,p_int,p_ext,Porasint,Probfp,Repeticiones,Politica4,tpool4,test4,quienes4,Cuaren4,Diascuarentena4,Diasatras4,scalar_asint,TestSyn4,distribuir4,vg)


        fr_mQua=fr_mQua/Repeticiones
        fr_mQua2=fr_mQua2/Repeticiones
        fr_mInf=fr_mInf/Repeticiones
        fr_mInf2=fr_mInf2/Repeticiones
        fr_mInf3=fr_mInf3/Repeticiones
        fr_mNFp=fr_mNFp/Repeticiones
        fr_T=fr_T/Repeticiones
        fr_T2=fr_T2/Repeticiones
        fr_mSy=fr_mSy/Repeticiones
        fr_VInf=fr_VInf/Repeticiones
 #       [fr_mQua,fr_mQua2, fr_mInf,fr_mInf2,fr_mInf3, fr_mNFp, fr_T, fr_T2,fr_mSy, fr_VInf]=[fr_mQua,fr_mQua2, fr_mInf,fr_mInf2,fr_mInf3, fr_mNFp, fr_T, fr_T2,fr_mSy, fr_VInf]/Repeticiones
    end
ff+=1
end
###############################################################################
